...
class RandEnumKeys(RandEnum):
    ...
    def _command_args(self):
        # XXX: only outputs the list of keys, but values are irrelevant anyway
...
class RandString(RandField):
    _DEFAULT_CHARS = b"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"
